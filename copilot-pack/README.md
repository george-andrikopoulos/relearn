...
├── README.md                          this file
└── .github/
    └── copilot-instructions.md        86 rules, 2163 lines — the instruction file
```
...
|---|---:|---|
| `global` | 33 | The repository discipline and its controls, plus language-agnostic verification, provenance, disclosure and cost reasoning — see below |
